...
export default function PolitikumWelcome({ onJoin }) {
  ...
  return (
    <div className="relative min-h-screen w-screen overflow-hidden text-slate-100" style={{ backgroundImage: "url('/assets/lobby_bg.webp')", backgroundSize: 'cover', backgroundPosition: 'center center', backgroundRepeat: 'no-repeat' }}>
      ...
      <div className="relative z-10 min-h-screen px-0 pt-0 pb-0">
        <header className="fixed top-0 left-0 right-0 z-30">
          <div className="rounded-none border-b border-amber-500/15 bg-[linear-gradient(180deg,rgba(28,15,11,0.82),rgba(12,7,6,0.62))] shadow-[0_14px_36px_rgba(0,0,0,0.32)] backdrop-blur-md px-6 md:px-8 py-3 flex flex-wrap items-center gap-3 justify-between">
        ...
        <main className="relative mx-auto max-w-[1520px] pt-[66px] md:pt-[72px] pb-[42px] min-h-screen">
          <div className="relative h-[calc(100vh-112px)] min-h-[560px]">
            <div className="absolute left-[170px] top-[90px] w-[290px]">
            ...
            <div className="absolute left-[170px] top-[196px] w-[360px]">
              <SectionCard title="Чат лобби" eyebrow="Общий канал" className="h-[250px] flex flex-col">
            ...
            <div className="absolute right-[170px] top-[196px] w-[400px]">
              <SectionCard title="Лобби и подключение" eyebrow="Список игр" right={<div className="text-[11px] font-mono text-amber-100/55">{activeGameCount} открыто</div>} className="h-[250px] flex flex-col overflow-hidden">
                ...
                {rightTab === 'games' && (
                  <div className="flex-1 min-h-0 flex flex-col overflow-hidden">
                    <div className="rounded-[18px] border border-amber-500/10 bg-black/22 px-4 py-2.5 text-[12px] text-amber-100/80 font-serif shrink-0">Название игры будет запрошено после нажатия на кнопку <span className="font-black uppercase tracking-[0.18em] text-amber-50">Создать игру</span>.</div>
                    <div className="mt-4 flex-1 min-h-0 overflow-y-auto pr-1 custom-scrollbar overscroll-contain space-y-3">
            ...
            <div className="absolute left-1/2 -translate-x-1/2 bottom-[12px] w-full max-w-[560px] px-4 text-center">
              <button onClick={createMatch} disabled={loading} className="min-w-[320px] px-8 py-4 rounded-2xl bg-amber-500 hover:bg-amber-400 text-stone-950 font-black text-[18px] uppercase tracking-[0.14em] shadow-[0_14px_36px_rgba(251,191,36,0.28)] transition-all active:scale-[0.99] disabled:opacity-60">Создать игру</button>
            </div>
          </div>
        </main>
        <footer className="fixed bottom-0 left-0 right-0 z-30">
          <div className="rounded-none border-t border-amber-500/10 bg-black/22 backdrop-blur-md px-6 md:px-8 py-2.5 flex flex-wrap items-center justify-center gap-3 text-sm font-mono text-amber-100/72 shadow-[0_-10px_28px_rgba(0,0,0,0.28)]">
