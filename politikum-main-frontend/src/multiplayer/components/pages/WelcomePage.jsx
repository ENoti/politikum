  ...
  return (
    <div className="relative min-h-screen w-screen overflow-hidden text-slate-100" style={{ backgroundImage: "url('/assets/lobby_bg.webp')", backgroundSize: 'cover', backgroundPosition: 'center center', backgroundRepeat: 'no-repeat' }}>
      ...
      <div className="relative z-10 min-h-screen px-0 pt-0 pb-0">
        ...
        <main className="relative min-h-screen pt-[88px] pb-[58px]">
          <div className="relative h-[calc(100vh-146px)] min-h-[560px] mx-auto max-w-[1520px]">
            <div className="absolute left-6 top-[18px] w-[300px]">
              <SectionCard title="Новости" eyebrow="Сводка" className="overflow-hidden">
                <div className="max-h-[58px] overflow-hidden">
                  <NewsPanel />
                </div>
              </SectionCard>
            </div>

            <div className="absolute left-6 top-[232px] w-[360px]">
              <SectionCard title="Чат лобби" eyebrow="Общий канал" className="h-[260px] flex flex-col">
            ...
            <div className="absolute right-6 top-[232px] w-[400px]">
              <SectionCard title="Лобби и подключение" eyebrow="Список игр" right={<div className="text-[11px] font-mono text-amber-100/55">{activeGameCount} открыто</div>} className="h-[260px] flex flex-col overflow-hidden">
                ...
                {rightTab === 'games' && (
                  <div className="flex-1 min-h-0 flex flex-col overflow-hidden">
                    ...
                    <div className="mt-4 overflow-y-auto pr-1 custom-scrollbar flex-1 min-h-0 overscroll-contain space-y-3">
            ...
            <div className="absolute left-1/2 -translate-x-1/2 bottom-[18px] w-full max-w-[560px] px-4 text-center">
